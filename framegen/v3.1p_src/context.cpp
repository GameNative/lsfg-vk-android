...
std::vector<std::pair<const char*, const Core::Image*>>
        Context::debugInternalImages() const {
    return {
        { "mip0", &this->mipmaps.getOutImages().at(0) },
        { "gamma6", &this->gamma.at(6).getOutImage() },
        { "delta2a", &this->delta.at(2).getOutImage1() },
        { "delta2b", &this->delta.at(2).getOutImage2() },
    };
}
